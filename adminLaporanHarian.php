      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbar-ex-collapse">
          <ul class="nav navbar-nav navbar-right">
            ...
            <li>
              <a href="#">Senarai Pegawai</a>
            </li>
            <li>
              <a href="#">Status Keberadaan</a>
            </li>
            <li>
              <a href="#">Bahagian/Unit</a>
            </li>
            <li>
          ...
          <p class="navbar-left navbar-text">Signed in as
            <a href="#" class="navbar-link"><?php echo"$sesusername"?></a>
          </p>
        </div>
      </div>
    </div>
...
<!--<input type="text" class="form-control" placeholder="Waktu Keluar" name="pgw_wkt_keluar" id = "pgw_wkt_keluar" value="<?php if (isset ($_POST ['pgw_wkt_keluar'])) echo $_POST ['pgw_wkt_keluar']; ?>">-->
                    <input type="datetime-local" class="form-control" value="2016-01-01T00:00" name="pgw_wkt_keluar" id = "pgw_wkt_keluar"/>
                ...
                <div class="col-sm-4">
                  ...
                  <input type="submit" name="wkt_keluar" class="btn btn-danger" id="wkt_keluar" value="Keluar" alt="Keluar" tabindex="5" /></div>
              </div>
              <br>
              <br>
              <div class="form-group">
...
<!--<input type="text" class="form-control" placeholder="Waktu Masuk" name="pgw_wkt_masuk" id = "pgw_wkt_masuk" value="<?php if (isset ($_POST ['pgw_wkt_masuk'])) echo $_POST ['pgw_wkt_masuk']; ?>">-->
                    <input type="datetime-local" class="form-control" value="2016-01-01T00:00" name="pgw_wkt_masuk" id = "pgw_wkt_masuk"/>
                </div>
                <div class="col-sm-4">
                  <i class="fa fa-calendar fa-fw fa-lg text-muted"></i>
                  ...
                  <input type="submit" name="wkt_masuk" class="btn btn-success" id="wkt_masuk" value="Masuk" alt="Masuk" tabindex="6" /></div>
              </div>
            </form>
          </div>
